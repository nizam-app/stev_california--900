  ...
  Widget build(BuildContext context) {
    final statusColors = {
      BookingStatus.pending: (
        _SellerHomeColors.yellow50,
        _SellerHomeColors.yellow700,
        _SellerHomeColors.yellow200,
      ),
      BookingStatus.confirmed: (
        _SellerHomeColors.green50,
        _SellerHomeColors.green700,
        _SellerHomeColors.green200,
      ),
      BookingStatus.inProgress: (
        _SellerHomeColors.blue50,
        _SellerHomeColors.blue700,
        _SellerHomeColors.blue200,
      ),
      BookingStatus.completed: (
        _SellerHomeColors.gray50,
        _SellerHomeColors.gray700,
        _SellerHomeColors.gray200,
      ),
      BookingStatus.cancelled: (
        _SellerHomeColors.red50,
        _SellerHomeColors.red700,
        _SellerHomeColors.red200,
      ),
    };
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 15.sp,
                            fontWeight: FontWeight.w600,
                            color: _SellerHomeColors.gray900,
                          ),
                        ),
                        SizedBox(height: 2.h),
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 14.sp,
                            color: _SellerHomeColors.gray500,
                          ),
                        ),
                      ],
                    ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: TextStyle(
                            fontSize: 14.sp,
                            color: _SellerHomeColors.gray700,
                            height: 1.35,
                          ),
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
...
class _InfoChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(horizontal: 12.w, vertical: 8.h),
      decoration: BoxDecoration(
        color: _SellerHomeColors.gray50,
        borderRadius: BorderRadius.circular(8.r),
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(icon, size: 16.sp, color: _SellerHomeColors.gray400),
          SizedBox(width: 8.w),
          Text(
            text,
            style: TextStyle(
